...
namespace Logger
{
    ...
    public class Log {
        public class OnLogMessageEventArgs : EventArgs {
            ...
            public OnLogMessageEventArgs(string msg, LogType type, string timestmp, string formattedMsg, string cat) {
                Message = msg;
                LogType = type;
                Timestamp = timestmp;
        ...
        public event Action<OnLogMessageEventArgs> OnLogMessage;
        ...
        private void _logLineFormatted(object msg, LogType type, string cat = "") {
            ...
            string category = generateCat(cat);
            string msgFormatted = category + ": " + message;

            switch (type) {
                case LogType.Debug: msgFormatted = "[D]" + msgFormatted; break;
                case LogType.Error: msgFormatted = "[E]" + msgFormatted; break;
                case LogType.Info: msgFormatted = "[I]" + msgFormatted; break;
                case LogType.Verbose: msgFormatted = "[V]" + msgFormatted; break;
                case LogType.Warning: msgFormatted = "[W]" + msgFormatted; break;
            }

            if (AddTimestamp)
                msgFormatted = "[" + timestamp + "]" + msgFormatted;

            if (OnLogMessage != null) {
                OnLogMessage.Invoke(new OnLogMessageEventArgs(message, type, timestamp, msgFormatted, category));
            }

            _logLine(msgFormatted);
        }
        ...
        public static void Info(object msg, string cat = "") => Instance()._logLineFormatted(msg, LogType.Info, cat);
        ...
        /// <param name="msg">The message to log.</param>
        /// <param name="cat">The category of the message.</param>
        public static void Error(object msg, string cat = "") => Instance()._logLineFormatted(msg, LogType.Error, cat);
        ...
        /// <param name="msg">The message to log.</param>
        /// <param name="cat">The category of the message.</param>
        public static void Warning(object msg, string cat = "") => Instance()._logLineFormatted(msg, LogType.Warning, cat);
        ...
        /// <param name="msg">The message to log.</param>
        /// <param name="cat">The category of the message.</param>
        public static void Debug(object msg, string cat = "") => Instance()._logLineFormatted(msg, LogType.Debug, cat);
        ...
        /// <param name="msg">The message to log.</param>
        /// <param name="cat">The category of the message.</param>
        public static void Verbose(object msg, string cat = "") => Instance()._logLineFormatted(msg, LogType.Verbose, cat);

        /// <summary>
        /// Add a file that will have log lines written to it.
        /// </summary>
        /// <param name="filePath">The path to the file.</param>
        public static void AddLogFile(string filePath) => Instance()._addFile(filePath);
    }
}
